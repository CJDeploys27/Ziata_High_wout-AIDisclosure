...
export const INITIAL_MESSAGES: Message[] = [
  ...
  {
    id: 2,
    text: "I am powered by Artificial Intelligence, but I do not have the capability to learn from past interactions. Are you ready to talk to Ziata?",
    sender: Sender.Ziata,
    options: [
...
export const DIALOGUE_FLOW: Record<Topic, Dialogue & { questionOptions: string[][] }> = {
  [Topic.Sleep]: {
    questions: [
    ...
    responses: {
      ...
      MODERATE: {
        ...
        ENVIRONMENT: "Your environment supports sleep adequately but shows specific friction points (elements that make your life difficult). Identify the element that disrupts you most—light leakage, noise, temperature, or device proximity—and adjust that single variable first. Adjusting small, targeted elements of your environment has the potential to create large benefits by reducing disruptions that fragment sleep quality.",
        CONSISTENCY: "Your routine is mostly reliable, but minor variability weakens the continuity of your sleep cycles. Narrow the range of your bedtime and wake time to within a 30–45 minute window. Retain a short pre-sleep ritual, that you perform consistently, to maintain predictability for your nervous system. Consistency reinforces both circadian timing (your internal body clock) and behavioral momentum.",
      ...
      LOW: {
        ...
        COGNITIVE: "Your cognitive stance (mindframe) toward sleep is functional and adaptive. Maintain your current perspective by avoiding excessive attention to metrics or isolated disruptions. A flexible, non-evaluative mindset supports ongoing stability and prevents unnecessary cognitive load. Always be receptive to new tactics to help with the mental elements of sleep.",
      },
    },
  },
  [Topic.Exercise]: {
    ...
    questionOptions: [
        ...
        ["Frustration", "Guilt", "Acceptance", "Disappointment"],
        ["Team sports", "Yoga", "Running", "Weightlifting"],
        ["No association", "Small", "Moderate", "Strong"],
        ["Bad planning", "Crutch", "Neutral", "Reward"],
        ["Self-expression", "Duty", "Stress relief", "Performance"],
        ["Disruptive", "Less satisfying", "Appealing", "Beneficial"]
    ],
    responses: {
        HIGH: {
            BIOLOGY: "Your energy pattern suggests a biological mismatch between your recovery needs and your current activity level. Before increasing exercise volume, establish a reliable fatigue baseline (base level of energy). Begin with short, low-intensity sessions in that window. The objective is to stabilize circadian energy output, not to maximize exertion.",
            ENVIRONMENT: "Your responses indicate that environmental conditions are creating significant friction (elements that make things difficult). Reduce the physical distance between intention and action by preparing your setup in advance: place exercise clothing, water, or minimal equipment in a visible, accessible location. Identify one environmental trigger—such as morning light, work break, or end-of-day transition—and pair your movement session with that anchor.",
            CONSISTENCY: "Your movement pattern shows irregularity, which disrupts both energy stabilization and confidence. Begin with a micro-routine: a small, repeatable action performed at the same time daily, regardless of intensity. Examples include one minute of stretching, a short walk, or a mobility drill. Once consistency is established, gradually expand duration or intensity.",
            ...
            COGNITIVE: "Your exercise challenges seem connected to a mental model that frames movement as an all-or-nothing task. This creates internal resistance and exaggerates the perceived cost of initiation. Reframe movement as an energy-stabilizing input rather than a performance requirement. Lower the threshold for what counts as success and focus on accumulating small, repeatable units rather than completing full sessions.",
        },
        MODERATE: {
  ...
  [Topic.Food]: {
    questions: [
        ...
        "What is your least favorite eating habit that you would like to change?",
        "If you had to describe your overall relationship with food in one feeling, what would it be and why?",
    ...
    questionOptions: [
        ["Major", "Minor", "No need", "Strong"],
        ["Very little", "Some", "Moderate", "Mostly"],
        ["Snacking", "Mindless", "Emotional", "Skipping"],
        ["Guilt", "Confusion", "Practicality", "Comfort"],
        ["Motivated", "Disappointed", "Indifferent", "Sluggish"],
        ["Focused", "Overly full", "Rushed", "Satisfied"],
        ["Rarely", "Equal", "Necessity", "Emotional"],
        ["Confuse", "Reduce", "No change", "Boost"]
    ],
    responses: {
        HIGH: {
            ...
            ENVIRONMENT: "Your eating pattern appears heavily influenced by your immediate environment. High-visibility, high-reward foods create repeated cue-driven eating cycles. Modify one environmental element first: reduce visibility of trigger foods, reorganize the kitchen so nutrient-dense items are at eye level, and pre-portion convenience items are accessible when possible. Environment design functions as a primary lever because it changes exposure before self-control is required.",
            CONSISTENCY: "Your responses indicate irregular meal timing and sporadic adherence to dietary intentions. To stabilize intake, select one reliable daily anchor—breakfast window, midday meal, or evening meal—and make this the first point of consistency. Once a single anchor is predictable, extend structure outward to the meals surrounding it. Consistency is built by sequencing changes, not by total dietary overhaul.",
            EMOTIONAL: "Your eating behavior appears closely tied to emotional activation such as stress, overwhelm, or fatigue. Before adjusting food choices, introduce a 2–5 minute pause when an emotionally driven urge arises. Use this moment to identify whether the impulse originates from hunger or emotion. If emotional, substitute a brief regulatory action—such as breathing or stepping away—before deciding whether to eat.",
            COGNITIVE: "Your cognitive (mental) stance toward food appears shaped by rigid rules, moralized categories, or all-or-nothing interpretations. This pattern increases dietary volatility because small deviations are interpreted as failure. Shift to a proportional model: emphasize frequency rather than abstinence. Instead of eliminating foods, adjust how often they appear.",
        },
        MODERATE: {
  ...
  [Topic.Habit]: {
    ...
    questionOptions: [
        ...
        ["Commitment", "Comfort", "Perfectionism", "Undeserving"],
        ["Anxious", "Acceptance", "Disciplined", "Indifference"],
        ["Scheduling", "Limits", "Minimizing", "Work when I can"],
        ["Small starts", "Consistency", "Motivation", "Kindness"]
    ],
    responses: {
        HIGH: {
        ...
        MODERATE: {
            ...
            CONSISTENCY: "You demonstrate periodic consistency, but certain days break the rhythm and weaken momentum. Introduce a fallback version of the habit for disrupted days—a brief action that maintains continuity. This prevents zero days, which are the primary disruptor of cumulative habit-building. Consistency is key.",
